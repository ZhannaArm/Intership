#ifndef UNIVERSITYTIMETABLINGSYSTEM_CONSTANTS_H
...
constexpr auto ADD_INSTRUCTOR = "addInstructor";
constexpr auto ARG_ADD_INSTRUCTOR = "--addInstructor";
constexpr auto ADD_COURSE = "addCourse";
constexpr auto ARG_ADD_COURSE = "--addCourse";
constexpr auto ADD_TIMESLOT = "addTimeSlot";
constexpr auto ARG_ADD_TIME_SLOT = "--addTimeSlot";
constexpr auto ARG_SCHEDULE = "--schedule";
constexpr auto ARG_AVAILABILITY = "--availability";
constexpr auto ARG_PREFERRED_COURSES = "--preferredCourses";
